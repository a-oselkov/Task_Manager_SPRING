...
class TaskStatusControllerTest {
    ...
    public void createTaskAuthorized() throws Exception {
        ...
        final TaskStatus taskStatus = taskStatusRepository.findByName(TEST_TASKSTATUS);
    ...
    public void updateTaskStatus() throws Exception {
        utils.regDefaultTaskStatusAuthorized();
        final TaskStatus oldTaskStatus = taskStatusRepository.findByName(TEST_TASKSTATUS);
        ...
        final TaskStatus newTaskStatus = taskStatusRepository.findByName(TEST_TASKSTATUS_UPD);
